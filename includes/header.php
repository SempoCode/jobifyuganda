<?php 
//define the constant part of the url to use
define("APPURL","http://localhost/jobifyuganda");

//strating the sessions
session_start(); 
?>
...
<html lang="en">
  <head>
    <title>Jobify Uganda</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <link rel="shortcut icon" href="ju-logo.png">
    ...
    <header class="site-navbar mt-3">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="site-logo col-6"><a href="<?php echo APPURL; ?>">Jobify Uganda</a></div>
