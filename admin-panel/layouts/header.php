...
<?php 
  ...
  define("ADMINURL", "http://localhost/jobifyuganda/admin-panel");
...
<head>
    ...
    <!-- <link rel="shortcurt icon" href="<?php //echo ADMINURL; ?>/images/ju-logo.png"> -->

    <link rel="icon" type="image/x-icon" href="<?php echo ADMINURL; ?>/images/ju-logo.png">
...
<div id="wrapper">
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      <div class="container">
      <a class="navbar-brand" href="#">JOBIFY UGANDA</a>
    ...
    <?php if(isset($_SESSION['adminname'])) : ?>
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav side-nav" >
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL; ?>/clients/workers.php" style="margin-left: 20px;">Workers</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL; ?>/clients/companies.php" style="margin-left: 20px;">Companies</a>
          </li>
          <?php endif; ?>
